...
<?php
	...
	$rid=mysql_query("select * from student where usn=$id") or die(mysql_error());
	...
	While($row=mysql_fetch_row($rid))
	{
		...
		print "<tr><td>E-Mail Address</td><td>$row[4]</td></tr>";
                print "<tr><td>Phone Number</td><td>$row[5]</td></tr>";
		print "<tr><td>Date Of Birth</td><td>$row[6]</td></tr>";
		print "<tr><td>Password</td><td>$row[7]</td></tr>";
		print "<tr><td>Address</td><td>$row[8]</td></tr>";
		print "<tr><td colspan=2><a href=StudentPage.html><img src=images/back.png height=75 width=75></a></p></td></tr>";
                print "</table>";
	}
