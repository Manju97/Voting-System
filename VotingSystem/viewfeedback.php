...
<html>
<head>
<title>Online Voting System | View FeedBack</title>
...
<center>
<center><b><font size=24>FeedBack List</font></b></center>
...
<?php
	...
	$rid=mysql_query("select * from feedback") or die(mysql_error());
	print "<table><tr><td>Name</td><td>E-Mail Address</td><td>Phone Number</td><td>Subjects</td></tr>";
	...
	print "</tr><td colspan=5><a href=AdminPage.html><img src=images/back.png height=75 width=75></a></p></td></tr>";
	print "</table>";
